...
function adv_search(){
    ...
    function processForm(event){
      ...
      // https://stackoverflow.com/questions/44037953/javascript-style-color-doesnt-work
      ...
      setTimeout(() => {adv_heading.style.color = old_color;}, 500);
      
      // Using HTML attributes for the momment
